    ...
    public class Camera : IDisposable
    {
        ...
        private void GraphBuilding_ConnectPins()
        {
            ...
            finally
            {
                ...
                CameraHelpers.SafeReleaseComObject(pinTeeInput);
                pinTeeInput = null;

                CameraHelpers.SafeReleaseComObject(pinTeePreview);
                pinTeePreview = null;

                CameraHelpers.SafeReleaseComObject(pinTeeCapture);
                pinTeeCapture = null;

                CameraHelpers.SafeReleaseComObject(pinSampleGrabberInput);
                pinSampleGrabberInput = null;

                CameraHelpers.SafeReleaseComObject(pinRendererInput);
